  ...
  const getPostsForProfile = (profileName: CategoryKey | 'Agency') => {
    ...
    if (profileName === 'Agency') {
      return Array.from({ length: 12 }, (_, i) => ({
        ...
        userAvatar: '/Uploads/28534233-055a-4890-b414-1429c0288a35.png',
        timestamp: `${i + 1}h`,
      ...
      <div className="p-4">
        ...
        <div className="flex items-start space-x-4 mb-4">
          <div className="w-20 h-20 rounded-full overflow-hidden">
            <img src="/Uploads/28534233-055a-4890-b414-1429c0288a35.png" alt="Social Hive Logo" className="w-full h-full object-cover" />
          </div>
