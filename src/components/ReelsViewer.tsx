...
const ReelsViewer = ({ reels, initialIndex, category, onClose }: ReelsViewerProps) => {
  ...
  const formattedReels = reels.map(reel => ({
    ...
    avatar: reel.avatar || '/Uploads/28534233-055a-4890-b414-1429c0288a35.png',
          ...
          >
            {formattedReels.length > 0 && (
              <ReelActionRail
                ...
                avatar={formattedReels[currentIndex].avatar || '/Uploads/28534233-055a-4890-b414-1429c0288a35.png'}
